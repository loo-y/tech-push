/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b38c253021586fd7f05dd8745ce2e748)
// Runtime types generated with workerd@1.20250730.0 2025-04-01 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		D1_DATABASE_ID: string;
		D1_DATABASE_ID_PREVIEW: string;
		R2_BASE_URL: string;
		R2_BASE_URL_PREVIEW: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "D1_DATABASE_ID" | "D1_DATABASE_ID_PREVIEW" | "R2_BASE_URL" | "R2_BASE_URL_PREVIEW" | "API_SECRET_KEY">> {}
}
